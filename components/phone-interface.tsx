...
const messages: Message[] = [
  ...
  { text: "मुझे आपके क्षेत्र में नट्स और बोल्ट्स के विक्रेता मिल गए हैं।...", sender: "ai", delay: 3500 },
  { text: "Client is speaking...", sender: "user", delay: 5000 },
  { text: "नमस्ते अमित, मुझे बीस नट्स और बोल्ट्स की आवश्यकता है।...", sender: "ai", delay: 4500 },
];
