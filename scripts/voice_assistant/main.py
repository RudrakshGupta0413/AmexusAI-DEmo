...
def main():
    ...
    process_client_speech(message=client_message, filename=client_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=welcome_message, filename=welcome_file, tts_api_key=tts_api_key)

    searching_message = "I am looking for reliable vendors of high-quality nuts and bolts in your area."
    search_file = "search.mp3"
    convert_tts(message=searching_message, filename=search_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=get_info, filename=get_info_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=first_vendor_message, filename=first_vendor_file, tts_api_key=tts_api_key)
...
Total price (for twenty units): Two hundred rupees"""
    ...
    vendor_one_text_to_speech(message=vendor_1_speak_message, filename=vendor_1_speak_file, tts_api_key=tts_api_key)

    first_vendor_thankyou_message = "Thank you, Amit! Have a good day."
    first_vendor_thankyou_message_file = "first_vendor_thankyou.mp3"
    convert_tts(message=first_vendor_thankyou_message, filename=first_vendor_thankyou_message_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=second_vendor_message, filename=second_vendor_file, tts_api_key=tts_api_key)
...
Total price (for twenty units): One hundred sixty rupees"""
    ...
    vendor_two_text_to_speech(message=vendor_2_speak_message, filename=vendor_2_speak_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=second_vendor_thankyou_message, filename=second_vendor_thankyou_message_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=reverse_bidding_message, filename=reverse_bidding_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=confirmation_message, filename=confirmation_file, tts_api_key=tts_api_key)
    ...
    convert_tts(message=second_vendor_message2, filename=second_vendor_file2, tts_api_key=tts_api_key)
    ...
    convert_tts(message=client_message, filename=client_message_file, tts_api_key=tts_api_key)
